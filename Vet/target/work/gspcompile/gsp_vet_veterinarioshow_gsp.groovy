...
printHtmlPart(13)
invokeTag('message','g',28,['code':("veterinario.crmv.label"),'default':("Crmv")],-1)
printHtmlPart(14)
invokeTag('fieldValue','g',30,['bean':(veterinarioInstance),'field':("crmv")],-1)
printHtmlPart(15)
}
printHtmlPart(16)
createTagBody(2, {->
...
invokeTag('link','g',38,['class':("edit"),'action':("edit"),'resource':(veterinarioInstance)],3)
printHtmlPart(18)
...
invokeTag('form','g',41,['url':([resource:veterinarioInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1473892453512L
