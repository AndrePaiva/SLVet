...
class gsp_vet_laudocreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/laudo/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'laudo.label', default: 'Laudo'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',25,['bean':(laudoInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(laudoInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
