...
class gsp_vet_animalcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/animal/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'animal.label', default: 'Animal'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
