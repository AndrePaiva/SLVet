...
createTagBody(1, {->
printHtmlPart(7)
invokeTag('image','asset',21,['src':("grails_logo.png"),'alt':("Grails")],-1)
printHtmlPart(8)
invokeTag('message','g',22,['code':("sytem.name"),'default':("SLVet - Sistema de Laudo Veterinário")],-1)
printHtmlPart(9)
...
public static final long LAST_MODIFIED = 1473982223164L
