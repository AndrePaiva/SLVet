...
class gsp_easygrid_templates_easygrid_visualizationGridRenderer_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/easygrid-1.7.1/grails-app/views/templates/easygrid/_visualizationGridRenderer.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1401124472605L
