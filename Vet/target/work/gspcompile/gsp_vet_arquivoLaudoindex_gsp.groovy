...
class gsp_vet_arquivoLaudoindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/arquivoLaudo/index.gsp" }
public Object run() {
Writer out = getOut()
...
loop:{
int i = 0
for( arquivoLaudoInstance in (arquivoLaudoInstanceList) ) {
printHtmlPart(15)
