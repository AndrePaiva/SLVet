...
class gsp_vet_layoutslogin_gsp extends GroovyPage {
...
expressionOut.print(request.contextPath)
printHtmlPart(7)
invokeTag('stylesheet','asset',22,['src':("application.css")],-1)
printHtmlPart(1)
...
public static final long LAST_MODIFIED = 1479498488804L
