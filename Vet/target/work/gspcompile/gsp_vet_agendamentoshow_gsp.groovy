...
printHtmlPart(12)
if(true && (agendamentoInstance?.data)) {
printHtmlPart(13)
invokeTag('message','g',28,['code':("agendamento.data.label"),'default':("Data")],-1)
printHtmlPart(14)
invokeTag('formatDate','g',30,['date':(agendamentoInstance?.data)],-1)
printHtmlPart(15)
}
printHtmlPart(16)
createTagBody(2, {->
...
invokeTag('link','g',38,['class':("edit"),'action':("edit"),'resource':(agendamentoInstance)],3)
printHtmlPart(18)
...
invokeTag('form','g',41,['url':([resource:agendamentoInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1473892492316L
