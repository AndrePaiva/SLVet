...
class gsp_easygrid_templates_easygrid_classicGridRenderer_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/easygrid-1.7.1/grails-app/views/templates/easygrid/_classicGridRenderer.gsp" }
public Object run() {
Writer out = getOut()
