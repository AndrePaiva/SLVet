...
class gsp_easygrid_templates_easygrid_filterFormRenderer_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/easygrid-1.7.1/grails-app/views/templates/easygrid/_filterFormRenderer.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(4)
for( _it1468876586 in (gridConfig.filterForm.fields) ) {
changeItVariable(_it1468876586)
printHtmlPart(5)
