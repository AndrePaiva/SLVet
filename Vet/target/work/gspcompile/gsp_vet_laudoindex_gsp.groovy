...
printHtmlPart(11)
invokeTag('sortableColumn','g',27,['property':("arquivo"),'title':(message(code: 'laudo.arquivo.label', default: 'Arquivo'))],-1)
printHtmlPart(12)
invokeTag('sortableColumn','g',29,['property':("data"),'title':(message(code: 'laudo.data.label', default: 'Data'))],-1)
printHtmlPart(13)
loop:{
int i = 0
...
invokeTag('link','g',37,['action':("show"),'id':(laudoInstance.id)],3)
printHtmlPart(16)
...
printHtmlPart(18)
invokeTag('paginate','g',46,['total':(laudoInstanceCount ?: 0)],-1)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1473459161069L
